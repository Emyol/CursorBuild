import type { PromptId } from './contract.js';
...
export const PROMPTS: ReadonlyMap<PromptId, Prompt> = buildRegistry();

export const ALL_PROMPTS: readonly Prompt[] = [...PROMPTS.values()];

export function lookupPrompt(id: string): Prompt | undefined {
  return PROMPTS.get(id as PromptId);
}
